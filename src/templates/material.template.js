(function(window) {
    ...
    epepite.DatePicker.TEMPLATES.material =
        ...
        + '<span class="%WEEK_ITEM_CLASS% %WEEK_LABEL_CLASS%">%DAY_1%</span>'
        + '<span class="%WEEK_ITEM_CLASS% %WEEK_LABEL_CLASS%">%DAY_2%</span><span class="%WEEK_ITEM_CLASS% %WEEK_LABEL_CLASS%">%DAY_3%</span>'
        + '<span class="%WEEK_ITEM_CLASS% %WEEK_LABEL_CLASS%">%DAY_4%</span><span class="%WEEK_ITEM_CLASS% %WEEK_LABEL_CLASS%">%DAY_5%</span>'
        + '<span class="%WEEK_ITEM_CLASS% %WEEK_LABEL_CLASS%">%DAY_6%</span><span class="%WEEK_ITEM_CLASS% %WEEK_LABEL_CLASS%">%DAY_0%</span></div></div><div class="%DAY_CONTAINER_CLASS%"></div></div></div>'
    ;
